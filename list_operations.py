...
def custom_append(input_list, value):
    """
        ...
        and return nothing
    """
    #Slicing IS THE ANSWERRRRRR
    #We use custom_len to get the total number of items in a list.
    #Then we do some funky list slice assignment input_list[Total_length:] = [value]
    #This essentially replaces list indexes that don't exist with the value.
    #wtf Python list magic
    #type this all out properly later
